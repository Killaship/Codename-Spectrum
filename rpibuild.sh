...
clang -target  i686-unknown-none -Wall -Wextra -fno-stack-protector -m32 -c kernel/kernel.c -o kc.o -fuse-ld=gold -m elf_i386 -T link.ld -o kernel.elf kasm.o kc.o #boot.o
