...
cd -
clang -target i686-unknown-none -Wall -Wextra -fno-stack-protector -c kernel/kernel.c -o kc.o

gold -m elf_i386 -T link.ld -o kernel.elf kernel/kasm.o kc.o #boot.o
